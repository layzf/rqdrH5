!function(a,b) {
	function c(){var b=f.getBoundingClientRect().width;b/i>750&&(b=750*i);var c=b/(750/70);f.style.fontSize=c+"px",k.rem=a.rem=c
}
...
if(g) {
	...
	var m=h.getAttribute("content");if(m){var n=m.match(/initial\-dpr=([\d\.]+)/),o=m.match(/maximum\-dpr=([\d\.]+)/);n&&(i=parseFloat(n[1]),j=parseFloat((1/i).toFixed(2))),o&&(i=parseFloat(o[1]),j=parseFloat((1/i).toFixed(2)))
}}
